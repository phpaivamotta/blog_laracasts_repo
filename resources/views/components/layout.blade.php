        ...
        <footer id="newsletter" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            ...
            <div class="relative space-x-4 inline-flex mt-10 text-gray-700">
                <a href="https://twitter.com/PolianaPorce/">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="hover:text-blue-500" width="25">
                ...
                <a href="https://www.linkedin.com/in/jessica-szklarz-a04a6984/">
                    <svg width="40" viewBox="0 3 25 25" class="hover:text-blue-500">
                        <path fill="currentColor" d="M19.75 5.39v13.22a1.14 1.14 0 0 1-1.14 1.14H5.39a1.14 1.14 0 0 1-1.14-1.14V5.39a1.14 1.14 0 0 1 1.14-1.14h13.22a1.14 1.14 0 0 1 1.14 1.14zM8.81 10.18H6.53v7.3H8.8v-7.3zM9 7.67a1.31 1.31 0 0 0-1.3-1.32h-.04a1.32 1.32 0 0 0 0 2.64A1.31 1.31 0 0 0 9 7.71v-.04zm8.46 5.37c0-2.2-1.4-3.05-2.78-3.05a2.6 2.6 0 0 0-2.3 1.18h-.07v-1h-2.14v7.3h2.28V13.6a1.51 1.51 0 0 1 1.36-1.63h.09c.72 0 1.26.45 1.26 1.6v3.91h2.28l.02-4.43z"></path>
                    </svg>
                </a>
            </div>
