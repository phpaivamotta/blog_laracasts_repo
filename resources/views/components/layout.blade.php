    ...
    <section class="px-6 py-8">
        ...
        <footer id="newsletter" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            ...
            <div class="relative space-x-4 inline-flex mt-10 text-gray-700">
                <a href="https://twitter.com/jeszkl_rz">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 hover:text-white">
                ...
                <a href="https://www.linkedin.com/in/jessica-szklarz-a04a6984/">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" class="w-5 h-5 hover:text-white">
                        <!--! Font Awesome Pro 6.0.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
