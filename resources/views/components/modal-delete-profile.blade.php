<div x-data="{ show: @entangle($attributes->wire('model')) }" x-show="show" @keydown.escape.window="show=false" style="display: none">
    ...
    <div class="bg-white border border-gray-400 shadow-sm p-4 lg:max-w-sm max-w-xs m-auto rounded-md fixed inset-0 h-48"
        ...
        <div class="flex flex-col h-full justify-between">
            ...
            <main>
                <p>Seu perfil não poderá ser recuperado.</p>
            </main>
            ...
            <footer>
                ...
                <button type="button" class="bg-blue-500 hover:bg-blue-600 text-xs py-2 px-4 rounded-md text-white mr-2"
