        ...
        <div class="flex-1 flex flex-col justify-between">
            ...
            <footer class="flex justify-between items-center mt-8">
                <div class="flex items-center text-sm">
                    ...
                    <!-- Likes -->
                    <svg viewBox="-10 -10 40 40" class="w-14 lg:w-9">
                    ...
                    <div class="ml-2 mr-2">
                        <h5 class="text-lg lg:text-sm text-gray-700 font-semibold">{{ $post->likeCount  }}</h5>
                    </div>

                    <!-- comments -->
                    <svg viewBox="-10 -10 40 40" version="1.1" class="w-14 lg:w-9">
                    ...
                    <div class="ml-2">
                        <h5 class="text-lg lg:text-sm text-gray-700 font-semibold">{{ $post->comment->count() }}</h5>
                    </div>
