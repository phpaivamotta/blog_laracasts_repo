<div class="px-6 py-8">
    <main class="max-w-3xl lg:max-w-lg mx-auto mt-10">
        <x-panel>
            <h1 class="text-center font-bold text-2xl lg:text-xl">Cadastre-se</h1>

            <form wire:submit.prevent="store" enctype="multipart/form-data" class="mt-6 lg:mt-10">
                @csrf
                ...
                <div class="lg:flex lg:items-center mt-6 mb-2">
                    ...
                    <div class="flex items-center">
                        <button type="button">
                            <svg wire:click="removeSelectedProfilePic" viewBox="-5 -5 30 30" version="1.1"
                                class="w-11 lg:w-8" xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="/login"
                    class="text-sm lg:text-xs text-blue-500 hover:text-blue-900 underline inline-block mb-6">
                    Já é cadastrado?
                </a>
