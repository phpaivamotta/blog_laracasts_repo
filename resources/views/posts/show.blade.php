        ...
        <main class="max-w-6xl mx-auto mt-10 lg:mt-20 space-y-6">
            <article class="max-w-5xl lg:max-w-4xl mx-auto lg:grid lg:grid-cols-12 gap-x-10">
                <div class="col-span-4 lg:text-center pt-14 lg:pt-14 mb-10">
                    ...
                    <p class="mt-4 block text-gray-400 text-lg lg:text-xs">
                    ...
                    <div class="flex items-center lg:justify-left text-4xl lg:text-sm mt-10 lg:mt-4">
                        ...
                        <a href="/sobre">
                            <img src="{{ isset($post->author->profile_pic)
                                ...
                                alt="Foto de Perfil" class="rounded-xl h-36 w-36 lg:h-16 lg:w-16">
                        </a>

                        <div class="ml-6 lg:ml-3 text-left">
                    ...
                    <div class="flex items-center lg:justify-left mt-4 text-gray-700">
                        <a href="https://twitter.com/PolianaPorce/" target="_blank">
                            <svg viewBox="0 0 512 512" class="hover:text-blue-500 w-10 lg:w-6">
                        ...
                        <a href="https://www.linkedin.com/in/jessica-szklarz-a04a6984/" target="_blank">
                            <svg width="30" viewBox="0 0 25 25" class="hover:text-blue-500 w-14 lg:w-8 ml-6 lg:ml-1">
                                <path fill="currentColor"
                ...
                <div class="col-span-8">
                    ...
                    <h1 class="font-bold text-7xl lg:text-4xl mb-10">
                        {{ $post->title }}
                    </h1>
                        ...
                        <div x-data="{ show: false }" @click.away="show=false" class="mt-8">
                            ...
                            <div class="flex">
                                ...
                                <div x-show="show" class="flex bg-gray-300 rounded-xl px-3 space-x-2 items-center"
                                    ...
                                    <a href="{{ $links['facebook'] }}" target="_blank">
                                        <svg version="1.1" viewBox="0 0 512 512"
                                            class="text-my-gray hover:text-blue-500 w-16 lg:w-10"
                                ...
                                <button @click="show = !show">
                                    <svg viewBox="-10 -10 40 40" version="1.1" class="lg:w-16 w-32">
